...
const StoryForm = ({
  formHeading, title, description, contentLink, minimumPrice, category,
  image1, image2, image3, handleChange, handleSubmit, submitBtnName }) => {
      ...
      <div className="columns h-center">
        <div className="col-md-12 col-8 card bg-gray">
          ...
          <div className="card-header">
            <h2 className="h2 text-center">{formHeading}</h2>
